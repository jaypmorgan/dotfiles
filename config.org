...
Use company-mode for completion at point and company box to improve
the UI of the completion list in prog-modes.
...
For our programming buffers, I use =lsp-mode= to connect to a specific
LanguageServer.
