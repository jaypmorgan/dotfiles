...
(use-package ess ;; Emacs speaks statistics (R)
  ...
  (define-key ess-r-mode-map (kbd "<f7>") 'open-r-workspace)
  ...
  (require 'ess-rdired)
  (define-key ess-rdired-mode-map (kbd "p") 'ess-rdired-plot)
  (define-key ess-rdired-mode-map (kbd "e") 'ess-rdired-edit)
  (define-key ess-rdired-mode-map (kbd "v") 'ess-rdired-view)
